...
import type { UserCreateDto } from '@shop/shared/models/user.model';
...
export class UserFormComponent {
  ...
  getRedirectPath(): string {
    return this.router.url.includes('/admin/shop') ? '/admin/shop/users' : '/shop/users';
  }
  ...
  onSubmit(): void {
    ...
    request.subscribe({
      next: () => {
        this.messageService.success(id ? 'User updated.' : 'User created.');
        this.router.navigate([this.getRedirectPath()]);
